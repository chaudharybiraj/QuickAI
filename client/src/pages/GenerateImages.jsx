...
const GenerateImages = () => {
  ...
  const imageStyle = ['Realistic', 'Ghibli style', 'Anime style', 'Cartoon style', 'Fanstasy style', '3D style', 'Portrait style']
            ...
            </div>
            {
              ...
              <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
                ...
                <div className='mt-3 h-full'>
                  <img src={content} alt="image" className='w-full h-ull'/>
                </div>
              )
            }
