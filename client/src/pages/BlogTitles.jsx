...
axios.defaults.baseURL = import.meta.env.VITE_BASE_URL;
 ...
 const BlogTitles = () => {
    ...
    const onSubmitHandler = async (e)=>{
      ...
      try {
        setLoading(true)
        // const prompt = `Generate a blog titles for the keyword ${input} in the category of ${selectedCategory}`
        // const prompt = `Generate 10 creative, catchy and SEO-friendly blog titles for the keyword "${input}" in the category of "${selectedCategory}". Return them as a numbered list.`

        const prompt = `Generate 10 creative, catchy and SEO-friendly blog titles for the keyword "${input}" in the category of "${selectedCategory}". Return them as a numbered list only. No intro text, no explanation, just the numbered list.`
